...
const Dashboard = () => {
    ...
    <div>
        {/* BUSQUEDA */}
        <div className="items-center px-4 flex justify-center pt-2" >
        ...
        <nav className={estilos.contenedor}>
                <ul className={estilos.listaIconos}>
                    ...
                    {/* Lista de iconos */}
                    <li>
                        <a className={estilos.icono} href="#"><Image src={logong} alt="logong"></Image></a>
                    </li>
                    <li> 
                        <a className={estilos.icono} href="#"><Image src={logog1} alt="logog1"></Image></a>
                    </li>
                    <li> 
                        <a className={estilos.icono} href="#"><Image src={logocheck} alt="logocheck"></Image></a>
                    </li>
                    <li> 
                        <a className={estilos.icono} href="#"><Image src={logofce} alt="logofce"></Image></a>
                    </li>
                    {/* Fin Lista Iconos */}
                </ul>
                <ul>
                    <div className={estilos.logoNucleo2}>
                        <li>
                            <div className={estilos.logoPerfil}><Image className={estilos.imgPerfil} src={logousuario} alt="logousuario"></Image></div>
                        </li>
                    </div>
                </ul>
        </nav>
