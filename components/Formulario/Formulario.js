...
<div className="relative p-5 lg:px-20 flex flex-col md:flex-row items-center justify-center">
    ...
    <div className="bg-gray-900 border border-green-500 w-full lg:w-1/2 h-full p-5 pt-8 ">
        ...
        <a href="https://api.whatsapp.com/send?phone=5491132777917" className="flex items-center hover:text-white hover:bg-green-500 p-2 text-white">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="w-6 h-6 m-2" viewBox="0 0 20 20">
        ...
        <a href="https://t.me/NucleoIT_bot" className="flex items-center hover:text-white hover:bg-green-500 p-2 text-white">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="w-6 h-6 m-2" viewBox="0 0 20 20">
            <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8.287 5.906c-.778.324-2.334.994-4.666 2.01-.378.15-.577.298-.595.442-.03.243.275.339.69.47l.175.055c.408.133.958.288 1.243.294.26.006.549-.1.868-.32 2.179-1.471 3.304-2.214 3.374-2.23.05-.012.12-.026.166.016.047.041.042.12.037.141-.03.129-1.227 1.241-1.846 1.817-.193.18-.33.307-.358.336a8.154 8.154 0 0 1-.188.186c-.38.366-.664.64.015 1.088.327.216.589.393.85.571.284.194.568.387.936.629.093.06.183.125.27.187.331.236.63.448.997.414.214-.02.435-.22.547-.82.265-1.417.786-4.486.906-5.751a1.426 1.426 0 0 0-.013-.315.337.337 0 0 0-.114-.217.526.526 0 0 0-.31-.093c-.3.005-.763.166-2.984 1.09z"/>
        </svg>
            telegram
        </a>
        <a href="https://www.linkedin.com/company/n%C3%BAcleo-it/mycompany/" className="flex items-center hover:text-white hover:bg-green-500 p-2 text-white">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="w-6 h-6 m-2" viewBox="0 0 20 20">
            <path d="M0 1.146C0 .513.526 0 1.175 0h13.65C15.474 0 16 .513 16 1.146v13.708c0 .633-.526 1.146-1.175 1.146H1.175C.526 16 0 15.487 0 14.854V1.146zm4.943 12.248V6.169H2.542v7.225h2.401zm-1.2-8.212c.837 0 1.358-.554 1.358-1.248-.015-.709-.52-1.248-1.342-1.248-.822 0-1.359.54-1.359 1.248 0 .694.521 1.248 1.327 1.248h.016zm4.908 8.212V9.359c0-.216.016-.432.08-.586.173-.431.568-.878 1.232-.878.869 0 1.216.662 1.216 1.634v3.865h2.401V9.25c0-2.22-1.184-3.252-2.764-3.252-1.274 0-1.845.7-2.165 1.193v.025h-.016a5.54 5.54 0 0 1 .016-.025V6.169h-2.4c.03.678 0 7.225 0 7.225h2.4z"/>
        </svg>
            Linkedin
        </a>
        <a href="https://www.youtube.com/user/nucleoit" className="flex items-center hover:text-white hover:bg-green-500 p-2 text-white">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="w-6 h-6 m-2" viewBox="0 0 20 20">
        ...
        <a href="https://www.instagram.com/nucleoit/" className="flex items-center hover:text-white hover:bg-green-500 p-2 text-white">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="w-6 h-6 m-2" viewBox="0 0 20 20">
    ...
    <form onSubmit={sendEmail} action="#" className="w-full md:w-1/2 border border-green-500 p-6 bg-gray-900">
    ...
    <div>
        ...
        <input 
            type="tel" name="user_number" required 
            className="px-3 py-2 bg-gray-800 border border-green-900 focus:border-red-500 focus:outline-none focus:bg-gray-800 focus:text-green-500"
